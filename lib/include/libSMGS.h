 ...
 *
 */
#define IS_SMGS_DEVICE_INTERNAL_CMDID(x) (((CONFIG_SMGS_DEVICE_INTERNAL_CMDID_1_START)<=(x)) && ((CONFIG_SMGS_DEVICE_INTERNAL_CMDID_1_STOP)>=(x)))
 ...
 *
 */
#define IS_SMGS_DEVICE_INTERNAL_REGISTER_ADDRESS(x) ((((CONFIG_SMGS_DEVICE_INTERNAL_REGISTER_1_START)<=(x)) && ((CONFIG_SMGS_DEVICE_INTERNAL_REGISTER_1_STOP)>=(x))) || \
                                                     (((CONFIG_SMGS_DEVICE_INTERNAL_REGISTER_2_START)<=(x)) && ((CONFIG_SMGS_DEVICE_INTERNAL_REGISTER_2_STOP)>=(x))))
 ...
 *
 */
#define IS_SMGS_GATEWAY_INTERNAL_CMDID(x) (((CONFIG_SMGS_GATEWAY_INTERNAL_CMDID_1_START)<=(x)) && ((CONFIG_SMGS_GATEWAY_INTERNAL_CMDID_1_STOP)>=(x)))
 ...
 *
 */
#define IS_SMGS_GATEWAY_INTERNAL_REGISTER_ADDRESS(x) (((CONFIG_SMGS_GATEWAY_INTERNAL_REGISTER_1_START)<=(x)) && ((CONFIG_SMGS_GATEWAY_INTERNAL_REGISTER_1_STOP)>=(x)))
